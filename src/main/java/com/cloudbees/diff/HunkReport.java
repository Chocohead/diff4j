...
public class HunkReport {
    public final PatchStatus status;
    ...
    HunkReport(PatchStatus status, Throwable failure, int index, int fuzz, int hunkID) {
        this(status, failure, index, fuzz, hunkID, null);
    }

    HunkReport(PatchStatus status, Throwable failure, int index, int fuzz, int hunkID, Hunk hunk) {
        this.status = status;
    ...
    public boolean hasFailed() {
        return status == PatchStatus.Failure;
    }
}